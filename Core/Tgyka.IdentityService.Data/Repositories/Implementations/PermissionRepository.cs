...
namespace Tgyka.IdentityService.Data.Repositories.Implementations
{
    ...
    {
        public PermissionRepository(MssqlDbContext dbContext, IUnitOfWork unitofWork, IMapper mapper, TokenUser tokenUser) : base(dbContext, unitofWork, mapper, tokenUser)
        {
        }
    }
}
